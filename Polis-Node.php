...
define('HRVERSION',"/Polis Core:%s/Polis Ninja Port Checker:%s.%d/");
...
class Node {
	...
	public function __construct($ip, $port = 24127, $timeout = 5, $versionid = '1.0.0', $sversionid = '0.12.2.0', $protver = PROTOCOL_VERSION, $prot_magic = PROTOCOL_MAGIC) {
